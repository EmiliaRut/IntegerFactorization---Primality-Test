/*
 * Chrom is m and primality in each generation
 */
        ...
        try {
            ...
            while (in.hasNext()) {
                ...
                for (int i = 0; i < 30; i++) {
                    ...
                    if (g.getFittestChrom().getEval() == 0) {
                        foundTimes++;
                    ...
                    while(!g.converged() && g.getFittestChrom().getEval() != 0 && generations < 2000) {
...
//            System.out.println("Chrom is m and primality in each generation");
